  ...
  return (
    <div class="p-6 space-y-4">
      <div class="flex justify-between items-center">
        <h1 class="text-2xl font-bold">Loading Out</h1>
        <div class="space-x-2">
          <button
              ...
              <For each={data()}>
                {(row, i) => (
                  <tr>
                    ...
                    <td class="border p-2">{row.pic_load_out}</td>
                    <td class="border p-2">{row.load_out_date}</td>
                    <td class="border p-2">{row.load_out_notes}</td>
