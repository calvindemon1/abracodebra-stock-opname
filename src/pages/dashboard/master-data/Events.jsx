...
import { Edit, CircleX, CalendarDays, Plus, Save, X } from "lucide-solid";
        ...
        <div class="flex items-center gap-4 mb-6">
          ...
          <div>
            ...
            <p class="text-sm text-gray-500 mt-0.5">
              Kelola daftar kegiatan atau event untuk perusahaan.
            </p>
          </div>
        </div>
          ...
          <div class="flex flex-col sm:flex-row gap-3">
            <div class="relative flex-1">
              <input
                ...
                placeholder="e.g. BYD IIMS 2026, BCA Expoversary..."
                value={name()}
        ...
        <div class="bg-white rounded-2xl shadow-[0_8px_30px_rgb(0,0,0,0.04)] border border-gray-100 overflow-hidden">
          <table class="min-w-full text-sm text-left">
            ...
            <tbody class="divide-y divide-gray-50">
              {/* Loading State */}
              <Show when={events.loading && !loading()}>
                <tr>
                ...
                <tr>
                  <td colspan="3" class="p-12 text-center text-gray-500">
                    ...
                    <p class="text-sm mt-1">
                      Silakan tambah event melalui form di atas.
                    </p>
                  </td>
                </tr>
              </Show>
                ...
                {(item, i) => (
                  ...
                  >
                    ...
                    <td class="p-4 font-medium text-gray-700 flex items-center gap-3">
                      {/* Aksen titik warna Ungu khusus Events */}
