...
import { Edit, CircleX, MapPin, Plus, Save, X } from "lucide-solid";
        ...
        <div class="flex items-center gap-4 mb-6">
          ...
          <div>
            ...
            <p class="text-sm text-gray-500 mt-0.5">
              Kelola daftar lokasi penempatan aset perusahaan.
            </p>
          </div>
        </div>
          ...
          <div class="flex flex-col sm:flex-row gap-3">
            <div class="relative flex-1">
              <input
                ...
                placeholder="e.g. Office Kembar, Gudang, Event Area..."
                value={name()}
        ...
        <div class="bg-white rounded-2xl shadow-[0_8px_30px_rgb(0,0,0,0.04)] border border-gray-100 overflow-hidden">
          <table class="min-w-full text-sm text-left">
            ...
            <tbody class="divide-y divide-gray-50">
              {/* Loading State */}
              <Show when={locations.loading && !loading()}>
                <tr>
              ...
              >
                <tr>
                  <td colspan="3" class="p-12 text-center text-gray-500">
                    <MapPin size={40} class="mx-auto text-gray-300 mb-3" />
                    <p class="font-medium text-gray-600">
                      Belum ada data lokasi
                    </p>
                    <p class="text-sm mt-1">
                      Silakan tambah lokasi melalui form di atas.
                    </p>
                  </td>
                </tr>
              </Show>
                ...
                {(item, i) => (
                  ...
                  >
                    ...
                    <td class="p-4 font-medium text-gray-700 flex items-center gap-3">
                      <div class="w-2 h-2 rounded-full bg-blue-300 group-hover:bg-blue-600 transition-colors"></div>
                      {item.location_name}
                    </td>
