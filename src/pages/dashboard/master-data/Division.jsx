...
import { Edit, CircleX, Briefcase, Plus, Save, X } from "lucide-solid"; // Pake icon Briefcase
...
export default function Division() {
  ...
  const [divisions, { refetch }] = createResource(() =>
  ...
  const submit = async () => {
    ...
    try {
      if (editingId()) {
        await DivisionsService.update(editingId(), { division_name: name() });
        Swal.fire({
          icon: "success",
          title: "Berhasil!",
        ...
        await DivisionsService.create({ division_name: name() });
        Swal.fire({
          icon: "success",
          title: "Berhasil!",
      ...
      Swal.fire({
        icon: "error",
        title: "Error!",
        text: "Gagal menyimpan data divisi ❌",
        ...
        <div class="flex items-center gap-4 mb-6">
          ...
          <div>
            ...
            <p class="text-sm text-gray-500 mt-0.5">
              Kelola daftar divisi atau departemen perusahaan.
            </p>
          </div>
        </div>
          ...
          <div class="flex flex-col sm:flex-row gap-3">
            <div class="relative flex-1">
              <input
                ...
                placeholder="e.g. IT, Abracodebra, Video, Finance..."
                value={name()}
          ...
          <table class="min-w-full text-sm text-left">
            <thead class="bg-gray-50/80 text-gray-500 text-xs uppercase tracking-widest border-b border-gray-100">
              <tr>
                ...
                <th class="p-4 font-semibold">Division Name</th>
            ...
            <tbody class="divide-y divide-gray-50">
              {/* Loading State */}
              <Show when={divisions.loading && !loading()}>
                <tr>
                ...
                <tr>
                  <td colspan="3" class="p-12 text-center text-gray-500">
                    ...
                    <p class="text-sm mt-1">
                      Silakan tambah divisi melalui form di atas.
                    </p>
                  </td>
                </tr>
              </Show>
                ...
                {(item, i) => (
                  ...
                  >
                    ...
                    <td class="p-4 font-medium text-gray-700 flex items-center gap-3">
                      {/* Aksen titik warna Indigo khusus Divisions */}
                      <div class="w-2 h-2 rounded-full bg-indigo-300 group-hover:bg-indigo-600 transition-colors"></div>
                      {item.division_name}
                    </td>
